...
Avataan Windowsin komentorivi ja tarkistetaan onko Vagrant asennettu koneelle. Seurataan Vagrantin dokumentaation mukaisia ![ohjeita](https://developer.hashicorp.com/vagrant/docs/installation).  
